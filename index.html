...
<head> <!--"head" tag-->
  ...
  <meta charset="utf-8"> <!--An extra setting section (meta) describing the character set, utf-8 means unicode characters with 8 bits--> 
  <meta name="viewport" content="width=device-width, initial-scale=1"> <!----> 
  <!--Watch out! You can't comment in a "style" tag in this traditional way, you need to do this instead...-->
  <style> /*"style" tag, this is where each tag, class, and ID get their styles defined*/
    html {
      height: 100%;
    }
    ...
    .meetingBox{ /*".meetingBox" is a class that defines the style anytime anything uses the meetingBox class*/
      flex: 1;
      height: 100%; 
      width: 100%;
    ...
    .meetingTitle{ /*".meetingTitle h1" applies these styles to everything inside of the "meetingTitle" class that is a "h1" tag*/
      color:purple;
    }

    .slotBox{ /*"body.slotBox" is a class*/
      height: 100px;
      width: 100px;
...
<body> <!--"body" tag-->
    ...
    <div class="meetingTitle">
     ...
     <div class="slotBox" onclick="clickAlert(this)"> <!--"onclick" is an html field within the tag "div" that calls "clackAlert" which is javascript-->
        date: monday at 5
     </div>
